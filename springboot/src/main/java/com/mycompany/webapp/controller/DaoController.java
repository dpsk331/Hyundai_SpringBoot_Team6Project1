...
public class DaoController {
	...
	public String boardWrite(Board board) throws Exception {
		...
		if(board.getBattach() != null && !board.getBattach().isEmpty()) {
			...
			File file = new File("C:/IMYENA/WorkSpace/Hyundai/Spring_upload_files/" + board.getBattachsname());
			mf.transferTo(file);
		}
	...
	public void battchDownload(int bno, HttpServletResponse response) throws Exception {
		Board board = boardService.getBoard(bno);
        ...
        String battachspath = "C:/IMYENA/WorkSpace/Hyundai/Spring_upload_files/" + battachsname;
        String battachtype = board.getBattachtype();
  
        //response.setHeader("Content-Disposition", "attachment; filename=\"" + battachoname + "\";"); //바로 다운로드, 안할 경우 파일이 탭으로 열림
